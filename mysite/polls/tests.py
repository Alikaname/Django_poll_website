...
class QuestionModelTests(TestCase):
    ...
    def test_was_published_recently_with_recent_question(self):
        '''
        was published_recently() return True for questions whose pub_date was within 1 day.
        '''
...
class QuestionViewIndexTests(TestCase):
    ...
    def test_future_question(self):
        ...
        response = slef.client.get(reverse("polls:index"))
        self.assertContains(response, "No polls available.")
        self.assertQuerysetEqual(response.context["latest_question_list"], [])
...
class QuestionDetailViewTests(TestCase):
    def test_future_question(self):
        '''
        The detail view of a question with a pub_date in the future returns error 404 not found.
        '''
    ...
    def test_past_question(self):
        '''
        The detail view of a question with a pub_date in the past displays a questions text.
        '''
